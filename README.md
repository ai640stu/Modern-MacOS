<h1 align="center">Modern MacOS</h1>
  <p align="center">Revamp Your Toolkit: The All-in-One Package of Modern Basic CLI Tools for macOS
  <p align="center">

<h2 align="center">Directions</h2>
  <p align="center">1. Clone this repo and <code>cd</code> into it. 
  <p align="center">2. Install Homebrew if not installed.
    <p align="center"><code>/bin/bash -c "$(curl -fsSL https://raw.githubusercontent.com/Homebrew/install/HEAD/install.sh)"</code>
  <p align="center">3. Run <code>bash install-modern.sh</code>
